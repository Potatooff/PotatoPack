...
class Component_ChatBox(c.CTkFrame):
    ...
    def __init__(
        ...
        self.user_input_text_box: c.CTkTextbox = c.CTkTextbox(self, font=(font_nunito_var, 16), height=35, corner_radius=10, border_width=2, border_color="#6b6c7b",
        ...
        self.user_input_send_button: c.CTkButton = c.CTkButton(self, text=" ", width=50, height=45, image=send_message_icon, corner_radius=10, fg_color=BG_COLOR,
        ...
        self.user_warning_text: c.CTkLabel = c.CTkLabel(self, text=warning_message_for_user, text_color="#CCCCCC", font=(font_montserrat_var, 14))
    ...
    def clear_user_input(self) -> None:
        self.user_input_text_box.destroy()
