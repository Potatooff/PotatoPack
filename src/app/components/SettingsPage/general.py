...
from src.app.Images import french_fries_icon


class Settings_GeneralPage(c.CTkFrame):
    ...
    def __init__(
        ...
        # Button
        self.button: c.CTkButton = c.CTkButton(self, image=french_fries_icon, fg_color=BG_COLOR, text="  General", border_width=3,
